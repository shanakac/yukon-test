...
export class StudentsComponent implements OnInit {
	...
	component: any;
    @ViewChild('studentHost', { read: ViewContainerRef, static:true }) componentHost: ViewContainerRef
	componentRef: ComponentRef<Component>

	private subsVar: any

	constructor(private resolver: ComponentFactoryResolver, private clService: ComponentLoaderService) { 
		this.component =  clService.loadComponentByName(Constants.COMP_NAME.student_list)
	}
